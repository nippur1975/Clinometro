...
def main():
    ...
    while not hecho:
        ...
        opciones_menu_barra = [
            ...
            TEXTOS[IDIOMA]["menu_servicio_datos"],
            TEXTOS[IDIOMA]["menu_activar"], # Nueva opción "ACTIVAR PRODUCTO"
                    ...
                    if toolbar_visible and not mostrar_ventana_config_serial and not mostrar_ventana_acerca_de and not mostrar_ventana_alarma and not mostrar_ventana_idioma:
                        for i, rect_opcion in enumerate(rects_opciones_menu_barra):
                            if rect_opcion.collidepoint(evento.pos):
                                if i == 0:  # Configuración de puerto
                                ...
                                elif i == 4: # Nueva opción: Activar Producto (índice 4)
                                    if PROGRAM_MODE == "LICENSED":
                                        # Opcional: Mostrar mensaje "Producto ya activado"
                                        # Por ahora, permitimos abrir la ventana igualmente.
                                        print("INFO: El producto ya está activado. Mostrando ventana de activación igualmente.")
                                    
                                    # Necesitamos obtener los IDs actuales de la máquina para pasarlos
                                    ...
                                    if activation_was_successful:
                                        ...
                                        # PROGRAM_MODE y ACTIVATED_SUCCESSFULLY ya se actualizan dentro de run_activation_sequence
                                    else:
                                        print("INFO: Ventana de activación cerrada desde el menú sin activación exitosa.")
                                        # No se inicia periodo de gracia aquí, ya que eso es solo para el primer intento.
                                        # El programa continúa en su estado actual (GRACE_PERIOD o TRIAL_EXPIRED).

                                elif i == 5:  # Acerca de (ahora es el índice 5)
