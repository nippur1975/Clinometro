...
TEXTOS = {
    "es": {
        ...
        "about_line5": "2025",
        "stealth_mode_title": "Modo Oculto",
        "stealth_mode_label": "Modo Oculto (requiere reinicio):",
        "on_button": "ON",
        "off_button": "OFF"
    },
    "en": {
        ...
        "about_line4": "Email: hugo_delacruz@hotmail.com",
        "about_line5": "2025",
        "stealth_mode_title": "Stealth Mode",
        "stealth_mode_label": "Stealth Mode (requires restart):",
        "on_button": "ON",
        "off_button": "OFF"
    }
}
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.MOUSEBUTTONDOWN:
                if evento.button == 1:  # Clic izquierdo
                    ...
                    elif mostrar_ventana_mode:
                        if rect_boton_stealth_on and rect_boton_stealth_on.collidepoint(evento.pos):
                            STEALTH_MODE = True
                            guardar_configuracion_serial(puerto, baudios)
                        elif rect_boton_stealth_off and rect_boton_stealth_off.collidepoint(evento.pos):
                            STEALTH_MODE = False
                            guardar_configuracion_serial(puerto, baudios)
                        elif 'rect_boton_cerrar_mode' in locals() and rect_boton_cerrar_mode.collidepoint(evento.pos):
                            mostrar_ventana_mode = False
