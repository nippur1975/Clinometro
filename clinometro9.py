...
def main():
    ...
    while not hecho:
        ...
        diametro_claraboya = 2 * radio_circulo_img
        claraboya_surface = pygame.Surface((diametro_claraboya, diametro_claraboya), pygame.SRCALPHA) # Superficie transparente                claraboya_surface.fill((0,0,0,0)) # Llenar con transparencia
